 ...
 * @author __USER__
 */
public class wlView extends javax.swing.JFrame {
	public int x1 = 106;
	public int y1 = 120;
	public int x2 = 106;
	public int y2 = 120;
	...
	class Play1 implements Runnable {
		...
		public void run() {
			...
			int mv1 = Integer.valueOf(move).intValue();
			for (int i = 0; i < mv1; i++) {
			...
			if (x1 == 282 && y1 == 120) {
				if (f1 == 0) {
					if (m1 > 300) {
						m1 = m1 - 300;
						jLabel48.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
						jLabel4.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/格子1.png")));
						f1 = 1;
					} else {
						f1 = 0;
						return;
					...
					if (f1lv == 0) {
						if (m1 > 100) {
							...
							jLabel48.setIcon(new javax.swing.ImageIcon(
									getClass().getResource("/images/Lv2.png")));
							f1lv = 1;
						} else {
							return;
						}
						...
						if (m1 > 100) {
							m1 = m1 - 100;
							jLabel48.setIcon(new javax.swing.ImageIcon(
									getClass().getResource("/images/Lv3.png")));
							f1lv = 2;
						} else {
							return;
						}
			...
			if (x1 == 458 && y1 == 120) {
				if (f2 == 0) {
					if (m1 > 300) {
						m1 = m1 - 300;
						jLabel49.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
			...
			if (x1 == 546 && y1 == 120) {
				if (f3 == 0) {
					if (m1 > 300) {
						m1 = m1 - 300;
						jLabel50.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
			...
			if (x1 == 634 && y1 == 190) {
				if (f4 == 0) {
					if (m1 > 100) {
						m1 = m1 - 300;
						jLabel51.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
						jLabel9.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/格子1.png")));
						f4 = 1;
					} else {
						f4 = 0;
			...
			if (x1 == 634 && y1 == 330) {
				if (f5 == 0) {
					if (m1 > 300) {
						m1 = m1 - 300;
						jLabel52.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
						jLabel11.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/格子1.png")));
						f5 = 1;
					} else {
						f5 = 0;
			...
			if (x1 == 634 && y1 == 400) {
				if (f6 == 0) {
					if (m1 > 300) {
						m1 = m1 - 300;
						jLabel53.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
						jLabel12.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/格子1.png")));
						f6 = 1;
					} else {
						f6 = 0;
			...
			if (x1 == 546 && y1 == 540) {
				if (f7 == 0) {
					if (m1 > 300) {
						m1 = m1 - 300;
						jLabel54.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
						jLabel15.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/格子1.png")));
						f7 = 1;
					} else {
						f7 = 0;
			...
			if (x1 == 458 && y1 == 540) {
				if (f8 == 0) {
					if (m1 > 300) {
						m1 = m1 - 300;
						jLabel55.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
			...
			if (x1 == 370 && y1 == 540) {
				if (f9 == 0) {
					if (m1 > 300) {
						m1 = m1 - 300;
						jLabel56.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
			...
			if (x1 == 194 && y1 == 540) {
				if (f10 == 0) {
					if (m1 > 300) {
						m1 = m1 - 300;
						jLabel57.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
						jLabel19.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/格子1.png")));
						f10 = 1;
					} else {
						f10 = 0;
			...
			if (x1 == 106 && y1 == 470) {
				if (f11 == 0) {
					...
					if (m1 > 300) {
						m1 = m1 - 300;
						jLabel58.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
						jLabel21.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/格子1.png")));
						f11 = 1;
					} else {
						f11 = 0;
			...
			if (x1 == 106 && y1 == 330) {
				if (f12 == 0) {
					if (m1 > 300) {
						m1 = m1 - 300;
						jLabel59.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
						jLabel23.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/格子1.png")));
						f12 = 1;
					} else {
						f12 = 0;
			...
			if (x1 == 106 && y1 == 260) {
				if (f13 == 0) {
					if (m1 > 300) {
						m1 = m1 - 300;
						jLabel60.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/Lv1.png")));
						jLabel24.setIcon(new javax.swing.ImageIcon(getClass()
								.getResource("/images/格子1.png")));
						f13 = 1;
					} else {
						f13 = 0;
	...
	class Play4 implements Runnable {
		...
		public void run() {
			...
			for (int i = 0; i < move; i++) {
				...
				if (106 <= x1 && x1 < 634 && y1 == 120) {
					...
					x1 = x1 + 88;
					jLabel26.setBounds(jLabel26.getX() + 88, jLabel26.getY(),
							50, 50);
					continue;
					...
					y1 = y1 + 70;
					jLabel26.setBounds(jLabel26.getX(), jLabel26.getY() + 70,
							50, 50);
					continue;
			...
			if (x1 == 282 && y1 == 120) {
				if (f1 == 0) {
					...
					if (f1lv == 0) {
						int res = JOptionPane.showConfirmDialog(null, "是否升级房子",
								"升级房子", JOptionPane.YES_NO_OPTION);
						if (res == JOptionPane.YES_OPTION) {
							m1 = m1 - 100;
							jLabel48.setIcon(new javax.swing.ImageIcon(
									getClass().getResource("/images/Lv2.png")));
			...
			if (x1 == 634 && y1 == 540) {
				m1 = m1 + 300;
				JOptionPane.showMessageDialog(null, "在宫中逛宫，捡到300文钱", "随机事件",
						JOptionPane.CANCEL_OPTION);
			}
			/*
			 * 暂停格子
			...
			if (x1 == 106 && y1 == 400) {
				m1 = m1 - 100;
				JOptionPane.showMessageDialog(null, "在宫中做错了事，被罚100文钱", "随机事件",
						JOptionPane.CANCEL_OPTION);
	...
	private void initComponents() {
		...
		jButton4.setBounds(0, 670, 90, 40);
		...
		layout.setHorizontalGroup(layout.createParallelGroup(
				...
				jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 794,
				Short.MAX_VALUE));
